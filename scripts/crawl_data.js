...
var logger = new (winston.Logger)({
    transports: [
        ...
        new winston.transports.File({
            filename: '/var/ratings/' + d + '-all_export.log'
        })
    ],
    exceptionHandlers: [
        new winston.transports.File({
...
var errorMessage = "";
loopOnArrayWithDelay(zipList, 10000, 0, function (e, i) {
        ctr++;
        var total = "";
        ...
        if (zipImported == false) {
                    ...
                    if (!dataFound) {
                        ...
                        fs.writeFile(path, jObj, 'utf8', function (error) {
                            if (error) {
                                ...
                                // logger.info("Successful Write Empty to " + path);
                            }
                        });
                    }
            ...
            logger.info("Zip code " + zip + " was already exported.");
        }


    }, function (i) {
        var path = '/var/ratings/' + d + '-all_exp_stats.txt';
