...
Listing.update({imported:'Y', status:'active', manage:null}, {$set: {'importDate': null}}, {upsert: false, multi: true}, function (err, num) {
    if (err) {
        console.log("Error updating " + err);
    } else {
        console.log("Success updating " + JSON.stringify(num));
    }
});
