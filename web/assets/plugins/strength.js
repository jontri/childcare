        ...
        init: function() {
            ...
            function GetPercentage(a, b) {
                ...
                function check_strength(thisval,thisid){
                    ...
                    if (total >= 5 && thisval.length > 9) {total += 1}
            ...
            function get_total(total,thisid){
                ...
                var thismeter = $('div[data-meter="'+thisid+'"]');
                 ...
                 thismeter.removeClass();
                thismeter.addClass('strong').html('Very Strong');
                }
                
                if (total == -1) { thismeter.removeClass(); thismeter.addClass('veryweak').html('very weak'); }
            }
